...
export function SignupEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Welcome to Interex!</E.Text>
				</h1>
				<p>
					<E.Text>
		...
		<div className="light bg-white text-slate-900 min-h-screen">
			<div className="container flex flex-col justify-center pt-20 pb-32">
				<div className="text-center">
					<h1 className="text-h1 text-slate-900">Let's start your journey!</h1>
					<p className="text-body-md text-slate-600 mt-3">
