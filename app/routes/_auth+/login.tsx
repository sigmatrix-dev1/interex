			...
			<div className="flex min-h-full flex-col justify-center pt-20 pb-32">
				<div className="mx-auto w-full max-w-md">
					<div className="flex flex-col gap-3 text-center">
						<h1 className="text-h1 text-slate-900">Welcome back!</h1>
							...
							<Form method="POST" {...getFormProps(form)}>
								...
								<Field
									...
									inputProps={{
										...
										autoFocus: true,
										className: 'lowercase bg-white border-slate-300 text-slate-900',
								...
								<div className="flex justify-between">
									...
									<div>
										<Link
											to="/forgot-password"
											className="text-body-xs font-semibold text-blue-600 hover:text-blue-800"
										>
											Forgot password?
										</Link>
									</div>
