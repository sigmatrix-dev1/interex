...
import { SubmissionPurpose } from '@prisma/client'

// Validation schema for creating a new submission
const CreateSubmissionSchema = z.object({
  title: z.string().min(1, 'Title is required'),
  purposeOfSubmission: z.nativeEnum(SubmissionPurpose),
...
export default function Submissions() {
  ...
  const submissionPurposes = [
    ...
    { value: 'PROVIDER_MANAGEMENT', label: 'Provider Management' },
    { value: 'POST_PAY_EMDR', label: 'Post-Pay eMDR Letters' },
    { value: 'PRE_PAY_EMDR', label: 'Pre-Pay eMDR Letters' },
    { value: 'POST_PAY_OTHER_EMDR', label: 'Post-pay Other eMDR Letters' },
    { value: 'PADL_RRL_LETTERS', label: 'PADL/RRL Letters' },
  ]
                ...
                <div className="flex flex-col gap-4 sm:flex-row">
                  ...
                  <div className="flex-1">
                    ...
                    >
                      ...
                      <option value="PROVIDER_MANAGEMENT">Provider Management</option>
                      <option value="POST_PAY_EMDR">Post-Pay eMDR Letters</option>
                      <option value="PRE_PAY_EMDR">Pre-Pay eMDR Letters</option>
                      <option value="POST_PAY_OTHER_EMDR">Post-pay Other eMDR Letters</option>
                      <option value="PADL_RRL_LETTERS">PADL/RRL Letters</option>
                    </select>
                  </div>
                </div>
              </div>
